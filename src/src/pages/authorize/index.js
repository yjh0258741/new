  ...
  return (
    <div className="authorize">
      ...
      <main>
        ...
        <div className="description">{(client_id && client_id.indexOf('google') !== -1) ? 'Google will access and control your devices.' : (LanguageMap[language || PageLanguage.Chinese].accessInfo)}</div>
